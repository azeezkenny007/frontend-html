...
var getBalanceButton = document.getElementById("balance");
var fundButton = document.getElementById("fund-button");
var ethAmountInput = document.getElementById("input-amount");
...
function fund() {
    return __awaiter(this, void 0, void 0, function () {
        var ethAmount, account, currentChain, request, hash, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
